...
import 'package:nike_project/features/screens/home_screens/bottom_navigation_bar_screens/home_screen/sub_screens/product_details_screen/bloc/product_add_to_cart_bloc.dart';
import 'package:nike_project/features/screens/home_screens/bottom_navigation_bar_screens/home_screen/sub_screens/product_details_screen/comments/comments_list_widget.dart';
    ...
    return BlocProvider(
      ...
      child: ScaffoldMessenger(
        ...
        child: Scaffold(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: Theme.of(context)
                                      .textTheme
                                      .titleSmall!
                                      .copyWith(color: kCaptionsTextColor, decoration: TextDecoration.lineThrough),
                                  maxLines: 1,
                                  overflow: TextOverflow.clip,
                                ),
                                Text(
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: Theme.of(context).textTheme.titleMedium!.copyWith(color: kGreyColor),
                          ),
                          TextButton(
                            onPressed: () {},
                            child: Text(
          ...
          floatingActionButton: BlocBuilder<ProductAddToCartBloc, ProductAddToCartState>(
